...
### 2024/06/29 (Saturday) <!--Trainer was unavailable for the following Monday-->
- #### Arrays
...
### 2024/07/02 (Tuesday)
- Continued with *Friends Pairing Problem* and *Subsets Problem* from last working day
...
- Shared the structure for the end exam
...
- Did some introduction to `priority queue`
...
- Syllabus has been fully covered
- #### Graphs
  - Taught on how to store graphs
  - Taught the theory of Adjacency Matrix
  - Taught the theory of Edge List
  - Taught the theory of Implicit Graph
- Reiterated on Dynamic Programming

### 2024/07/10 (Wednesday)
- Allowed time for working on the Project
- #### Permutations and Combinations
...
### 2024/07/12 (Friday)
- Project Day!!!
- Taken viva of the project, which included presentation, report and demo showcase

### 2024/07/13 (Saturday) <!-- Extra class on MyClass Platform -->
- Completed other student's pending end exam viva
- Did a quick walkthrough on topics discussed so far
- #### Arrays
